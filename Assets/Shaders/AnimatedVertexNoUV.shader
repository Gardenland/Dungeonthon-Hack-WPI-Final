		...
		struct Input {
		 ...
		 void vert (inout appdata_full v, out Input o) {
          ...
          //v.vertex.xyz *= 1- v.texcoord.y;
           v.vertex.y -= .5 * abs(sin(110*_Time + v.vertex.z * 2 )) * _Amplitude;
           v.vertex.x += .5 * sin(220*_Time + v.vertex.z * _Frequency ) * _Amplitude;
            v.vertex.y +=  .05* sin(200*_Time) * _Amplitude;
